 ...
 * @author ADMIN
 */
public class JDPesquisarPaciente extends javax.swing.JDialog {

    /**
     * Creates new form JDPesquisarPaciente
     */
    public JDPesquisarPaciente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Pesquisar por Paciente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDPesquisarPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDPesquisarPaciente dialog = new JDPesquisarPaciente(new javax.swing.JFrame(), true);
